  ...
  >
    ...
    <div className="w-full flex justify-between items-center">
      <div className="flex flex-1 flex-col md:ml-[62px] max-w-[650px]">
        <h4 className="font-semibold lg:text-[42px] text-[26px] text-white">{title}</h4>
        <p className="mt-[16px] font-normal lg:text-[20px] text-[14px] text-secondary-white">{subtitle}</p>
      </div>
      <div className="lg:flex hidden items-center justify-center w-[100px] h-[100px] bg-transparent border-[1px] border-white rounded-full cursor-pointer">
